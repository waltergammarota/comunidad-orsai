                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="cant_winners" id="cant_winners" class="form-control">
                            @for ($i = 1; $i < 5; $i++)
                                @if ($contest && $i == $contest->cant_winners) <option value="{{ $i }}"
                                selected>{{ $i }}</option>
                            @else
                    ...
                    <div class="row">
                        <div class="col-2 col-sm-2">
                            <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                                @for ($i = 0; $i < 3; $i++)
                                    <a class="nav-link {{ $i == 0 ? 'active' : '' }}" data-toggle="pill" href="#tabs-ronda-{{ $i + 1 }}" role="tab" aria-controls="vert-tabs-home"
                        ...
                        <div class="col-10 col-sm-10">
                            <div class="tab-content" id="vert-tabs-tabContent">
                                @for ($i = 0; $i < 3; $i++)
                                    <div class="{{ $i == 0 ? 'tab-pane text-left fade active show' : 'tab-pane text-left fade' }}" id="tabs-ronda-{{ $i + 1 }}" role="tabpanel"
                                         aria-labelledby="vert-tabs-home-tab">
                                        <div class="form-group">
                                            <input type="hidden" value="{{ $rondas[$i]->id }}" name="ronda_id[]">
                                            <h4 class="text-right"><span class="badge badge-light">Ronda {{ $i + 1 }}</span></h4>
                                        </div>
                                        <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="select2-warning">
                                                <select class="select2" id="input-{{ $i }}" name="inputs[{{ $i }}][]" multiple="multiple" data-placeholder="Selecciones campos"
                                                        data-dropdown-css-class="select2-warning"
                                                        style="width: 100%;">
                                                    @if (isset($rondas[$i]->inputs))
                                                        @foreach ($rondas[$i]->inputs as $input)
                                                            <option value="{{ $input->id }}" {{ $input->selected ? 'selected' : '' }}>{{ $input->id }} - {{ $input->name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
