                    ...
                    <form role="form" method="POST" action="{{url('admin/contest/store')}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Fecha inicio del concurso</label>
                            ...
                            {{--                            <div class="form-group">--}}
                            {{--                                <label for="exampleInputEmail1">Cantidad mínima de postulaciones para iniciar--}}
                            {{--                                    votación</label>--}}
                            {{--                                <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Cantidad"--}}
                            {{--                                       name="min_apps_qty"--}}
                            {{--                                       value="{{$contest?$contest->min_apps_qty:old('min_apps_qty')}}">--}}
                            {{--                            </div>--}}
                        </div>
