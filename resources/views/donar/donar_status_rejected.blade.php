                ...
                <div class="cuerpo_interna ">
                    <div class="">
                        <div class="titulo">
                            ...
                            <div>
                                <span class="color_rojo text_bold">Todavía no conseguiste tus {{$producto->fichas}} fichas.</span>
                        ...
                        <div class="form_ctrl input_  pd_20_tp">
                            <div class="align_center">
                                <span class="boton_redondeado resaltado_amarillo text_bold pd_25_lf_rg" id="reintentar">Reintentar donación</span>
...
@section('footer')
    <script>
        ...
        reintentar.click(function () {
            window.location = '{{url('donar/checkout?producto='.$producto->id)}}';
        })
    </script>
@endsection
