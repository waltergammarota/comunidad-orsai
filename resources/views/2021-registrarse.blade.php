        ...
        <form action="registrarse" method="POST" id="registro-form">
            @csrf
                    <div class="grilla_form contenedor_campos">
                        <div class="form_ctrl input_ col_3">
                            <div class="input_err">
								...
								<input type="text" id="nom_us" name="nombre" placeholder="Nombre" value="{{old('nombre')}}">
                        ...
                        <div class="form_ctrl input_ col_3">
                            <div class="input_err">
			                    ...
			                    <input type="text" id="ape_us" name="apellido" placeholder="Apellido" value="{{old('apellido')}}">
                    ...
                    <div class="form_ctrl input_ col_3 ">
                        ...
                        <button class="boton_redondeado resaltado_amarillo  mobile_100 custom_size g-recaptcha"
