...
@section('content')
        ...
        <div class="contenedor_interna concurso">
            <div class="cuerpo_interna">
                <article>
                    ...
                    <h2 class="title">CONCURSO INTERNACIONAL DE CUENTO CORTO CON JURADO POPULAR Y PREMIO INCALCULABLE EN
                        DÓLARES</h2>
                    <p class="nota"><strong>¡No te estreses!</strong> Tomate el tiempo para completar el formulario. Vas
                        a poder editarlo cuantas veces quieras con el botón GUARDAR. Solo cuando creas que ya está listo
                        usá el botón ENVIAR. <strong>Pero tampoco te cuelgues</strong>, recordá que podés enviar tu
                        cuento hasta el 1 de abril a la medianoche de Argentina.</p>
                    <hr>
                    <form action="#!">
                        <div class="concurso__form">
                            <div class="form_ctrl">
                                <div class="input_err">
                                    <div class="label-two-columns-flex">
                                        ...
                                        <a class="btn_tutorial" href="#videotutorial-1" rel="modal:open">Ver
                                            tutorial</a>
                                        <span class="disclaimer">Si tuvieras que vendernos tu cuento en una frase corta, ¿qué pondrías?</span>
                                    </div>
                                    <div class="content-input">
                                        <input type="text" name="motivo" id="motivo" value="" class="count-words"
                                               data-max="12" placeholder="[TEXTO]">
                                        <div class="content-count-words">Te quedan <span
                                                class="count-words-text"> 12  </span> palabras
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form_ctrl">
                                <div class="input_err">
                                    <div class="label-two-columns-flex">
                                        ...
                                        <span
                                            class="disclaimer">Explicá tu cuento en un tuit, pero sin espoilers.</span>
                                    </div>
                                    <div class="content-input">
                                        <textarea name="descripcion" id="descripcion" class="count-characters"
                                                  data-max="280" cols="30" rows="10" placeholder="[PÁRRAFO]"></textarea>
                                        <div class="content-count-words">Te quedan <span
                                                class="count-words-text"> 280 </span> caracteres
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form_ctrl">
                                <div class="input_err">
                                    <div class="label-two-columns-flex">
                                        ...
                                        <a href="#!" class="btn_tutorial" target="_blank">Ver tutorial</a>
                                        <span
                                            class="disclaimer">Agregá hasta cinco palabras que orienten tu historia.</span>
                                    </div>
                                    <div class="content-input">
                            ...
                            <div class="form_ctrl">
                                <div class="input_err">
                                    <div class="label-two-columns-flex">
                                        ...
                                        <a href="#!" class="btn_tutorial" target="_blank">Ver tutorial</a>
                                        <span
                                            class="disclaimer">Ayudá a que el jurado encuentre tu cuento por tema.</span>
                                    </div>
                                    <div class="content-input">
                            ...
                            <div class="form_ctrl">
                                <div class="input_err">
                                    <div class="label-two-columns-flex">
                                        ...
                                        <a href="#!" class="btn_tutorial" target="_blank">Ver tutorial</a>
                                        <span
                                            class="disclaimer">Acá te dejamos a solas (que la inspiración te ayude).</span>
                                    </div>
                                    <div class="content-input">
                                        <input type="text" name="motivo" id="motivo" class="count-characters"
                                               data-max="72" placeholder="[TEXTO]">
                                        <div class="content-count-words">Te quedan <span
                                                class="count-words-text"> 72 </span> caracteres
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form_ctrl">
                                <div class="input_err">
                                    ...
                                    <div class="content-input">
                                        <textarea name="cuento" id="cuento" cols="30" rows="20" class="count-words"
                                                  data-max="600" placeholder="[PÁRRAFO]"></textarea>
                                        <div class="content-count-words">Te quedan <span
                                                class="count-words-text"> 600 </span> palabras
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="input_err">
                                        <div id="check_div" class="input_err obligatorio">
                                            <label class="checkbox-container letra_chica">
                                                Acepto las <a href="https://comunidadorsai.org/terminos-y-condiciones"
                                                              target="_blank" rel="noopener noreferrer"
                                                              class="subrayado">Bases del concurso</a>.
                      ...
                      S262.617,349.696,213.977,349.696z"/>
                            ...
                            <div class="form_ctrl buttons">
                                <div class="input_err">
                                    <div class="label-centers">
                                        <a class="rounded-save--yellow" href="#sin_fichas" rel="modal:open">Enviar mi
                                            postulación</a>
                                    </div>
            ...
            <div class="form_ctrl input_" style="margin-top:20px;">
                <div class="align_left btn_noti_ico">
                    <a href="#" class="boton_redondeado btn_transparente"><span class="icon-angle-left"></span>
                        Volver</a>
                </div>
            </div>
        </div>
    ...
    <div id="videotutorial-1" class="modal videotutorial">
        <iframe width="800" height="600" src="https://www.youtube.com/embed/l1KAWIsilM4" frameborder="0"
