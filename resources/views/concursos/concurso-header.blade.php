                    ...
                    <div class="hero-nav-content  owl-carousel owl-theme">
                        ...
                        @else
                            <div class="hero-nav-item">
                                @if($isJuradoVip)
                                    <div class="content-nav center">
                                        <a href="{{url('estadisticas/'.$contest->id.'/'.$contest->getUrlName().'?force=true')}}"
                                           class="btn-postulacion">Estadísticas</a>
                                    </div>
                                @else
                                ...
                                <li class="cont_btn_filtro">
                                    <div class="form_ctrl input_">
                                        <div class="align_right">
                                            <a class="boton_redondeado resaltado_amarillo pd_50_lf_rg"
