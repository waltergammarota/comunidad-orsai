<header>
    <nav class="contenedor">
        <div id="contenedor_logo_header">
            <div id="logo_header">
                <a href="{{url('/')}}"><img src="{{url('recursos/front2021/comunidad-orsai.png')}}" alt="Comunidad Orsai"></a>
            </div>
        </div>
                    ...
                    <li class="resaltado_gris animated swing">
                        ...
                        <ul class="mensajes_menu">
                            ...
                            <li class="menu_configuracion">
                                <a href="{{url('notificaciones')}}" rel="noopener noreferrer"><span class="icon-vista"></span>Ver todas</a>
                                <a href="{{url('configuracion-notificaciones')}}" rel="noopener noreferrer"><span class="icon-config"></span>Preferencias</a>
                            </li>
                        </ul>
                    </li> 
                    <li id="clonar_perfil" class="menu_perfil">
                        ...
                        <div class="submenu">
                            <ul class="mensajes_menu contenedor"> 
                                ...
                                <li><a href="{{url('salir')}}" onclick="alertLogout()" rel="noopener noreferrer">Cerrar sesión</a></li>
                            </ul>
                        </div>
                    </li>   
                </ul>
