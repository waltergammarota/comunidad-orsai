        ...
        <article id="registro_js" class="contenedor grilla_asociarse_blanco">
            ...
            <div class="form_ctrl input_ col_3 ">
                <div class="align_center asoc_btn">
                    <button class="boton_redondeado resaltado_amarillo  mobile_100 custom_size " type="submit"
                        id="boton_susc">
                        Asociarme
                    </button>
            ...
            <div class="form_footer_term">
                <span class="text_center color_gris">
                    Este sitio está protegido por reCAPTCHA y se aplican la <a href="https://policies.google.com/privacy"
                        target="_blank">Política de privacidad</a> y los <a href="https://policies.google.com/terms"
                        target="_blank">Términos de servicio</a> de Google.
                </span>
            </div>
            </div>
        </article>
