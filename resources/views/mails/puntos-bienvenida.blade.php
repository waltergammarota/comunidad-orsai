...
<center
    ...
    <table
        ...
        <tr style="padding: 0; text-align: center; width: 600px;"
            bgcolor="#fffefe">
        ...
        <tr bgcolor="#fffefe">
            <td style="padding-bottom:20px;">
                <div
                    style="color: black; margin: 4% 10% 2%; text-align: justify;font-family: 'Space Mono', monospace;">
                    <p style="text-align: center; margin: 2px; font-size: 15px">
                        Activamos tu cuenta de email {{$email}}.
                        <strong></strong>
                        Ya puedes ingresar y disfrutar de la plataforma.
                    </p>
                </div>
            </td>
        </tr>
        <tr bgcolor="#fffefe" style="padding-top:20px;">
            <td>
                <div
                    ...
                    <p style="text-align: center; margin: 2px; font-size: 15px">
                        Ingresa a nuestra plataforma desde este link.
                        Te enviamos {{$amount}} puntos para que puedas votar y usarlos en la Plataforma.
                    </p>
                    <a href="{{$url}}" target="_blank"
                       style="background-color:#fafa00; text-decoration-line: underline;  margin-top:20px; margin-bottom:20px; font-size:18px; display: inline-block;text-align: center; color:black;">Ingresar</a>
                </div>
            </td>
        </tr>
        <tr bgcolor="#fffefe">
        ...
        <tr>
            <td style="text-align: center; ">
                <div
                    ...
                    <img style="width:100%;" src="{{url('recursos/orsai_logo_footer.svg')}}"
                         alt="Logo Orsai">
                </div>
                <div>
