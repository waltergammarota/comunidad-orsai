        ...
        <tr bgcolor="#fffefe">
            <td style="padding-bottom:20px;">
                <div
                    ...
                    <p style="text-align: center; margin: 2px; font-size: 15px">¡Muy sabia tu decisión de querer formar parte de la Comunidad Orsai, sólo te falta un paso más!</p><br/>  
                    <p style="text-align: center; margin: 2px; font-size: 15px"><strong>Hacé click en el botón para confirmar el registro de tu correo electrónico y ya estás apostando a las buenas historias.</strong> </p> 
                    </p>
