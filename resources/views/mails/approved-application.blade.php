        ...
        <tr bgcolor="#fffefe">
            <td style="padding-bottom:20px;">
                <div style="color: black; margin: 4% 5% 2%; text-align: center;font-family: 'Space Mono', monospace;">
                    ...
                    <a href="#" target="_blank" style="background-color:#fafa00; text-decoration-line: underline;  margin-top:20px; margin-bottom:20px; font-size:18px; display: inline-block;text-align: center; color:black;">Ver mi propuesta</a>
                </div>
            </td>
        </tr>
        <tr bgcolor="#fffefe" style="padding-top:20px;">
            <td>
                <div
                    ...
                    <a href="https://beta.fundacionorsai.org/participantes" target="_blank" style="background-color:#fafa00; text-decoration-line: underline;  margin-top:20px; margin-bottom:20px; font-size:18px; display: inline-block;text-align: center; color:black;">Mirá acá</a>
                </div>
            </td>
        </tr>
        <tr bgcolor="#fffefe">
