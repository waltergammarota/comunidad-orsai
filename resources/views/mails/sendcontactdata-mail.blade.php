    ...
    <table
        ...
        <tr style="padding: 0; text-align: center; width: 600px;"
            ...
            <td style="padding: 0; text-align: center; width: 600px;"
                bgcolor="#fffefe">
                <h1 style="margin-bottom:0;font-weight: 400; font-size:36px; line-height: 38px;font-family: 'Barlow+Condensed', sans-serif;">
                    <span style="font-weight: 700; display:block;">Contacto desde Comunidad Orsai</span>
                </h1>
            </td>
        </tr>
            ...
            <td style="padding-bottom:20px;">
                <div
                    ...
                    <p style="text-align: center; margin: 2px; font-size:16px;">
                        Asunto: {{$subject}} <br/>
                        Mensaje: {{$mensaje}} <br/>
                        Nombre y apellido: {{$name}} {{$lastName}} <br/>
                        Email: {{$email}} <br/>
                    </p>
                </div>
            </td>
