                                        ...
                                        <div class="cont_box">
                                            <div class="box">
                                                <input type="file" name="foto_perfil" id="foto_perfil"
                                                       class="inputfile_2 inputfile_per" accept="image/*"/>
                                                <img src="{{$avatar}}" alt="{{$username}}">
                                            </div>
                                            <label for="foto_perfil"
                                                   class="boton_redondeado resaltado_amarillo text_bold"><span> Cambiar avatar</span><span
                                                    class="icono icon-editar"></span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <form action="#">
                                ...
                                <div class="form_ctrl input_ col_3">
                                    <div class="input_err">
                                        ...
                                        <input type="text" name="userName" placeholder="Usuario" value="{{$username}}"
                                               class="obligatorio" id="userName" disabled>
                                    </div>
                                </div>
                                <div class="form_ctrl input_ col_3">
                                    <div class="input_err">
                                        <label class="text_medium">Correo Electrónico</label>
                                        <input type="email" name="email" value="{{$email}}" class="obligatorio"
                        ...
                        <div class="grilla_form">
                            <div class="form_ctrl input_ col_3">
                                <div class="input_err">
                                    ...
                                    <input type="text" name="name" value="{{$name}}" id="name" class="obligatorio"
                            ...
                            <div class="form_ctrl input_ col_3">
                                <div class="input_err">
                                    ...
                                    <input type="text" name="lastName" value="{{$lastName}}" id="lastName"
                                           class="obligatorio" splaceholder="Apellido" minlength="3" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grilla_form">
                            ...
                            <div class="form_ctrl input_ col_3">
                                <div class="input_err">
                                    ...
                                    <input type="text" name="passport" class="obligatorio"
                                           placeholder="Documento o pasaporte" id="passport" value="{{$passport}}">
                                </div>
                            </div>
                        </div>
                        <div class="grilla_form">
                            <div class="form_ctrl col_3">
                                <div class="input_err">
                                    ...
                                    <div class="select">
                                        <select name='birth_country' id='pais_suscriptor2' class=''>
                                            @foreach($paises as $pais)
                                                <option
                                                    value='{{$pais->nombre}}'
                                                    {{strtolower($birthCountry) == strtolower($pais->nombre)? "selected":""}}
                                                    data-iso="{{$pais->iso}}"
                                                >{{$pais->nombre}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="input_err">
                                    ...
                                    <div class="input_err">
                                        <small>¿No encontrás tu país, provincia o ciudad?
                                            <a class="subrayado" href="{{url('contacto')}}">Completá este
                                                formulario.</a></small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form_ctrl input_">
                            <div class="input_err">
                                ...
                                <textarea name="description" placeholder="Escribir..."
                        ...
                        <div class="form_ctrl input_">
                            <div class="align_right">
                                <button type="submit" id="boton_perfil"
                                        class="boton_redondeado resaltado_amarillo text_bold pd_50_lf_rg">Guardar
                                </button>
                            </div>
                        </div>
                    </form>
...
@section('footer')
    ...
    <script>
        ...
        $("#boton_perfil").click(function (event) {
            ...
            formData.append('birth_country', $("#pais_suscriptor2").val());
