        ...
        <div class="contenedor pd_20_tp_bt ft_size form_rel">
            ...
            <div class="grilla_perfil">
                <div id="formacion" class="fondo_blanco">
                    ...
                    <div class="mg_20"></div>
                    <form action="{{url('formacion/update')}}" method="POST">
                        @csrf
                        <div class="border_bt_form">
                            <div class="form_ctrl input_">
                                <div class="input_err">
                                    ...
                                    <span class="form_min_text color_gris cant_max_sel" data-cantop="5"
                                          data-texto="Agregá máximo 5 ítems"
                                          data-aviso="Ya agregaste suficientes items">Agregá máximo 5 ítems</span>
                                    @foreach($ocupacion as $item)
                                        <span class="globo_select resaltado_gris color_gris"
                                              data-selopt="{{$item}}"><input
                                                type="hidden" name="ocupacion[]" value="{{$item}}">{{$item}}<span
                                                class="globo_cerrar" onclick="eliminar_globo(this)">X</span></span>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                        <div class="border_bt_form">
                            <div class="grilla_form">
                                <div class="form_ctrl col_3">
                                    <div class="input_err">
                                        <label class="text_medium">Nombre de la empresa donde trabajás
                                            actualmente</label>
                                ...
                                <div class="form_ctrl col_3">
                                    <div class="input_err">
                                        ...
                                        <div class="select">
                                            <select id="sector_empresa" name="sector">
                                                <option selected disabled>Elegir...</option>
                            ...
                            <div class="form_ctrl input_">
                                <div class="input_err">
                                    ...
                                    @foreach($formacion as $item)
                                        <span class="globo_select resaltado_gris color_gris"
                                              data-selopt="{{$item}}"><input
                                                type="hidden" name="formacion_alc[]" value="{{$item}}">{{$item}}<span
                                                class="globo_cerrar" onclick="eliminar_globo(this)">X</span></span>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="form_ctrl input_">
                            <div class="input_err">
                                ...
                                <span class="form_min_text color_gris cant_max_sel" data-cantop="5"
                                      data-texto="Agregá máximo 5 ítems" data-aviso="Ya agregaste suficientes items">Agregá máximo 5 ítems</span>
                                @foreach($idiomas as $item)
                                    <span class="globo_select resaltado_gris color_gris"
                                          data-selopt="{{$item}}"><input
                                            type="hidden" name="idiomas[]" value="{{$item}}">{{$item}}<span
                                            class="globo_cerrar" onclick="eliminar_globo(this)">X</span></span>
                                @endforeach
                            </div>
                        </div>
                        <div class="form_ctrl input_">
                            <div class="align_right">
                                <button type="submit" class="boton_redondeado resaltado_amarillo text_bold pd_50_lf_rg">
                                    Guardar
                                </button>
                            </div>
                        </div>
