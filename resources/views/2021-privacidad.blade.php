        ...
        <article class="contenedor ft_size form_rel pd_15_extra">
            <div class="interna_panel_blanco">
                ...
                <div class="form_central_3 grilla_perfil grilla_panel_editable">
                    ...
                    <form action="{{url('configuracion-privacidad')}}" method="POST">
                        @csrf
                                    ...
                                    <div class="input_err">
                                        <div class="check_div input_err obligatorio">
                                            <label class="checkbox-container letra_chica text_bold">
                                                ...
                                                <input type="checkbox" id="cbox1" class="check_cond" value="1" checked
                                                       disabled>
                            ...
                            <div class="form_ctrl input_ col_6">
                                <div class="align_left">
                                    <div class="input_err">
                                        ...
                                        <div class="btn_leer_perfil">
                                            <a href="{{url('politica-de-privacidad')}}"
                                               class="boton_redondeado btn_transparente">Leer</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="grilla_form">
                                ...
                                <div class="form_ctrl input_ col_6">
                                    <div class="align_left">
                                        <div class="input_err">
                                            <div class="check_div input_err obligatorio">
                                                <label class="checkbox-container letra_chica text_bold">
                                                    Quiero que mis donaciones sean anónimas
                                                    <input type="checkbox" id="cbox1" class="check_cond" name="anonimo"
                                                           value="1"
                                                           @if($anonimo) checked @endif
                                                    >
                                                    <span class="crear_check"></span>
                                                </label>
                                            </div> 
                            ...
                            <div class="form_ctrl input_">
                                <div class="align_left">
                                    <button type="submit" id="boton_privacidad"
                                            class="boton_redondeado resaltado_amarillo text_bold pd_50_lf_rg w_200px">
                                        Guardar
                                    </button>
                                </div>
                            </div>
