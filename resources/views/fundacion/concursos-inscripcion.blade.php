            ...
            <div class="hero-nav-content">
              <div class="hero-nav-item">
                ...
                <div class="content-nav">
                  <span>Tenés tiempo hasta el</span>
                  <span class="strong">1 de abril</span>
                </div>
              </div>
              <div class="hero-nav-item">
                <div class="icon">
                ...
                <div class="content-nav column">
                  <span class="big-number">1.877</span>
...
<section class="resaltado_gris cuerpo_inscripcion">
  <div class="contenedor_interna">
    <div class="cuerpo_interna">
      <h2 class="cuerpo_inscripcion_title">Lorem ipsum dolor sit amet, consectetuer
        adipiscing elit, sed diam nonummy nibh
        euismod tincidunt ut laoreet.</h2>
      ...
      <div class="center-columns">
        <a href="#!" class="link">Leer bases y condiciones</a>
        <a href="#!" class="rounded-save--yellow">Subir mi postulación</a>
      </div>
    </div>
