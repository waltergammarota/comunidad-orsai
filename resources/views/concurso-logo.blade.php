        ...
        <div class="grid_70 mg_100">
            <ul id="bases">
                ...
                <li>
                    ...
                    <p class="li_aclara">(<sup>*</sup>) ¿Ud. aún no sabe como se    presenta un logo a concurso? <a href="#"   class="resaltado_amarillo">¡Mire este tutorial!</a></p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <p class="li_aclara">(<sup>*</sup>) ¿Ud. aún no sabe como &#x000AB;ponerle fichas&#x000BB; a un proyecto Orsai? <a  href="#" class="resaltado_amarillo">¡Mire este tutorial!</a></p>
                </li>
                <li>
