...
@section('content')  
    ...
    @if (Auth::check())
        ...
        <section id="modulos_administrador" style="padding:40px;text-align:center; background:rgb(209, 0, 0);font-size:16px;color:#fff;">
                        ...
                        <div class="btn_banner_100_fichas ">
                            <div class=" input_ ">
                                <div class="align_right">
                                    <a href="#" class="boton_redondeado resaltado_black pd_50_lf_rg">Proponer</a>
                                </div>
                            </div>
                        </div>
                        </div>
        ...
        <section class="pd_tp_bt pd_20">
            ...
            <div  class="contenedor grilla_3 mg_0 card_style_5_flex">
                ...
                <article class="card_style_5">
                    <a href="#">
                        ...
                        <h2 class="_barlow_text text_medium titulo">Primer encuentro nacional de escritores</h2>
                        <div class="form_ctrl input_">
                            <div class="align_left">
                ...
                <article class="card_style_5">
                    <a href="#">
                        ...
                        <h2 class="_barlow_text text_medium titulo">Proyectos de investigación con jurado abierto</h2>
                        <div class="form_ctrl input_">
                            <div class="align_left">
                                <span href="#" class="boton_redondeado btn_transparente_amarillo pd_25_lf_rg">Ver más</span>
                            </div>
                        </div>
                    </a>
                </article>
                <article class="card_style_5">
                    <a href="#">
                        ...
                        <h2 class="_barlow_text text_medium titulo">La revista científica digital de Fundación Orsai</h2>
                        <div class="form_ctrl input_">
                            <div class="align_left">
                                <span href="#" class="boton_redondeado btn_transparente_amarillo pd_25_lf_rg">Leer más</span>
                            </div>
                        </div>
                    </a>
                </article>
            ...
            <div class="contenedor grilla_3 mg_0">
                <div class="form_ctrl input_">
                    <div class="align_center">
                        <a href="#" class="boton_redondeado btn_transparente_negro pd_50_lf_rg">Ver todas las actividades</a>
                    </div>
                </div>
            </div>
            </div>
        ...
        <section class="pd_tp_bt pd_20">
            ...
            <div class="contenedor grilla_3 mg_0">
                <div class="form_ctrl input_">
                    <div class="align_center">
                        <a href="#" class="boton_redondeado btn_transparente_negro pd_50_lf_rg">Ver todos los cursos</a>
                    </div>
                </div>
            </div>
            </div>
                        ...
                        <div class="cuerpo_texto">
                            <div class="share_redes">
                                <div class="resaltado_gris">
                                    <a href="https://twitter.com/intent/tweet?text=MENSAJE&amp;url=LINKNOVEDAD&amp;via=comunidadorsai&amp;lang=es" target="_blank" onclick="window.open(this.href, this.target, 'width=400,height=300'); return false;" title="Twittear novedad" rel="noopener noreferrer"><span class="icono icon-tw"></span></a>
                                </div>
                                <div class="resaltado_gris">
                                    <a href="https://www.facebook.com/sharer/sharer.php?u=LINKNOVEDAD" title="Compartir esta novedad"  target="_blank" onclick="window.open(this.href, this.target, 'width=400,height=300'); return false;" rel="noopener noreferrer"><span class="icono icon-fb"></span></a>
                                </div>
                                <div class="resaltado_gris">
                                    <a href="whatsapp://send?text=MENSAJE – LINKNOVEDAD" data-action="share/whatsapp/share"  target="_blank" rel="noopener noreferrer"><span class="icono icon-whatsapp"></span></a>
                                </div> 
                            </div>
                            ...
                            <div class="nota_preview">
                                ...
                                <p>Conocé a los autores seleccionados para ponerle voz a tus cuentos. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis.</p>
                            </div>
                        </div>
