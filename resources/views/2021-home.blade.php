    ...
    <section class="mainslider">
        <div>
            <div id="owlMainSlider" class="owl-carousel owl-theme">
                <div>
                    <div class="item"><img src="{{url('recursos/front2021/cine-1.jpg')}}"
                                           alt="Orsai producirá cine y será una película aparte">
                ...
                <div>
                    <div class="item"><img src="{{url('recursos/front2021/cine-3.jpg')}}"
                                           alt="Presentamos el nuevo proyecto Orsai para la década que viene">
                        <div class="banner_text_inside">
                ...
                <div>
                    <div class="item"><img src="{{url('recursos/front2021/cine-2.jpg')}}"
                                           alt="Nuestra sede física: una historia que empezó hace 40 años">
                        <div class="banner_text_inside">
