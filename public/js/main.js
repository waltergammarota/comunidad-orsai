...
if (document.getElementsByClassName("contenedor_logos_participantes")[0]) {
	...
	for (var z = 0; z < grilla.length; z++) {
		...
		if (z == 0) {
			...
			get_logo.getElementsByTagName("h3")[1].innerHTML = grilla[z].votos + "<span> Fichas acumuladas</span>";
			get_logo.getElementsByClassName("ya_votado")[0].classList.add(grilla[z].votaste);
			...
			get_logo_est_clon.getElementsByTagName("h3")[1].innerHTML = grilla[z].votos + "<span> Fichas acumuladas</span>";
			...
			get_logo_est_clon.getElementsByClassName("ya_votado")[0].className = "ya_votado "+ grilla[z].votaste;
